...
# Load the datasets, can unit/weight
nodes = pd.read_csv('/home/meow/SupplyGraph/RawDataset/Homogenoeus/Nodes/Nodes.csv')
sales_order = pd.read_csv('/home/meow/SupplyGraph/RawDataset/Homogenoeus/Temporal Data/Unit/Sales Order .csv')
delivery_to_distributor = pd.read_csv('/home/meow/SupplyGraph/RawDataset/Homogenoeus/Temporal Data/Unit/Delivery to Distributor.csv')
factory_issue = pd.read_csv('/home/meow/SupplyGraph/RawDataset/Homogenoeus/Temporal Data/Unit/Factory Issue.csv')
production = pd.read_csv('/home/meow/SupplyGraph/RawDataset/Homogenoeus/Temporal Data/Unit/Production .csv')
